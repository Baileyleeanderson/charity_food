# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2018-03-29 23:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('charity', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='post_likes', to='donate.Food')),
                ('donor', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='donor_posts', to='donate.Food')),
                ('food', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='posts', to='donate.Food')),
            ],
        ),
        migrations.CreateModel(
            name='State',
